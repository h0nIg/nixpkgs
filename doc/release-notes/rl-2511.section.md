...
- Metadata identifier CPE has been added, which enables vulnerability search and partial SBOM generation. Maintainers are urged to enrich their drv.meta to contain the correct `identifiers.cpeParts.vendor` for matching.

- Metadata identifier pURL has been added, which enables SBOM generation.
