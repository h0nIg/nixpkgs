  ...
  self = stdenv.mkDerivation (
    ...
    // {
      ...
      meta = {
        ...
        identifiers = {
          ${if (attrs.src.meta.identifiers.purl or null) != null then "purl" else null} = attrs.src.meta.identifiers.purl;
          ${if (attrs.src.meta.identifiers.purls or null) != null then "purls" else null} = attrs.src.meta.identifiers.purls;
        };
      }
      // meta;
    }
